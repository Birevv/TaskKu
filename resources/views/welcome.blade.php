...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta
            name="description"
            content="TaskFlow brings projects, daily tasks, deadlines, and team workspaces into one calm, focused place."
        >

        <title>TaskFlow — Make progress feel effortless</title>

        @vite(['resources/css/app.css', 'resources/js/app.js'])
    </head>

    <body class="min-h-screen bg-stone-50 font-sans text-stone-950 antialiased selection:bg-amber-200 selection:text-amber-950">
        <div class="relative isolate overflow-hidden">
            <div
                class="pointer-events-none absolute inset-x-0 top-0 -z-10 h-[48rem] opacity-80"
                style="background:
            ...
            <nav class="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8 lg:px-10" aria-label="Main navigation">
                <a href="{{ route('home') }}" class="group inline-flex items-center gap-2.5" aria-label="TaskFlow home">
                    <span class="flex h-9 w-9 items-center justify-center rounded-xl bg-stone-950 text-lg font-bold text-amber-300 shadow-sm transition group-hover:-rotate-3">
                        ✓
                    </span>
                    <span class="text-lg font-bold tracking-tight">TaskFlow</span>
                </a>

                <div class="hidden items-center gap-8 text-sm font-medium text-stone-600 md:flex">
                    <a href="#features" class="transition hover:text-stone-950">Features</a>
                    <a href="#preview" class="transition hover:text-stone-950">How it works</a>
                </div>
            ...
            <main>
                <section class="mx-auto max-w-7xl px-5 pb-20 pt-14 sm:px-8 sm:pb-28 sm:pt-20 lg:px-10 lg:pt-24">
                    <div class="mx-auto max-w-4xl text-center">
                        <div class="mb-7 inline-flex items-center gap-2 rounded-full border border-amber-300/70 bg-amber-100/70 px-3.5 py-1.5 text-xs font-semibold text-amber-950 shadow-sm backdrop-blur">
                            <span class="h-1.5 w-1.5 rounded-full bg-amber-500"></span>
                            A calmer way to get things done
                        </div>

                        <h1 class="text-balance text-5xl font-bold tracking-[-0.045em] text-stone-950 sm:text-6xl lg:text-7xl">
                            Make room for work
                            <span class="relative whitespace-nowrap">
                                <span class="relative z-10">that matters.</span>
                                <span class="absolute inset-x-0 bottom-1 -z-0 h-3 rounded-full bg-amber-300/70 sm:h-4"></span>
                            </span>
                        </h1>

                        <p class="mx-auto mt-7 max-w-2xl text-pretty text-lg leading-8 text-stone-600 sm:text-xl">
                        ...
                        <div class="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
                            <a
                                href="{{ url('/app/register') }}"
                                class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-amber-400 px-6 py-3.5 text-base font-bold text-amber-950 shadow-[0_8px_30px_rgba(245,158,11,0.25)] transition hover:-translate-y-0.5 hover:bg-amber-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500 sm:w-auto"
                            >
                        ...
                        <p class="mt-4 text-sm text-stone-500">Free to start. No credit card required.</p>
                    </div>

                    <div id="preview" class="relative mx-auto mt-16 max-w-6xl scroll-mt-8 sm:mt-20">
                        <div class="absolute -inset-5 -z-10 rounded-[2.5rem] bg-gradient-to-r from-amber-200/60 via-orange-100/40 to-yellow-200/60 blur-2xl"></div>

                        <div class="overflow-hidden rounded-2xl border border-stone-900/10 bg-stone-950 p-2 shadow-[0_35px_90px_-25px_rgba(28,25,23,0.45)] sm:rounded-3xl sm:p-3">
                            <div class="flex items-center gap-1.5 px-3 py-2.5">
                                <span class="h-2.5 w-2.5 rounded-full bg-red-400"></span>
                                <span class="h-2.5 w-2.5 rounded-full bg-amber-400"></span>
                                <span class="h-2.5 w-2.5 rounded-full bg-emerald-400"></span>
                                <span class="ml-3 text-[11px] font-medium tracking-wide text-stone-500">TASKFLOW / PRODUCT TEAM</span>
                            </div>
                                        ...
                                        <div class="rounded-xl border border-stone-200 bg-white p-4 shadow-sm">
                                            ...
                                            <div class="mt-2 flex items-center gap-3">
                                                ...
                                                <span class="h-2 flex-1 overflow-hidden rounded-full bg-stone-100">
                                                    <span class="block h-full w-[72%] rounded-full bg-amber-400"></span>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="rounded-xl border border-stone-200 bg-white p-4 shadow-sm">
                    ...
                    <div class="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
                        <div class="max-w-2xl">
                            ...
                            <p class="mt-5 text-lg leading-8 text-stone-600">
                                From a quick personal task to a shared product launch, TaskFlow keeps the details visible and the next step clear.
                            </p>
                        </div>
                        ...
                        <div class="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                            @foreach ([
                                ...
                                <article class="group rounded-2xl border border-stone-200 bg-stone-50/60 p-6 transition hover:-translate-y-1 hover:border-amber-300 hover:bg-amber-50/40 hover:shadow-lg hover:shadow-amber-900/5">
                ...
                <section class="px-5 py-20 sm:px-8 sm:py-28 lg:px-10">
                    <div class="mx-auto max-w-5xl overflow-hidden rounded-3xl bg-stone-950 px-6 py-12 text-center text-white shadow-2xl sm:px-12 sm:py-16">
                        <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-amber-400 text-2xl font-bold text-amber-950">✓</div>
                        ...
                        <p class="mx-auto mt-4 max-w-xl text-base leading-7 text-stone-400">
                            Create your first workspace, bring every task into focus, and let TaskFlow handle the rest.
                        </p>
                        <a
                            href="{{ url('/app/register') }}"
            ...
            <footer class="border-t border-stone-200 bg-white">
                <div class="mx-auto flex max-w-7xl flex-col gap-5 px-5 py-8 text-sm text-stone-500 sm:flex-row sm:items-center sm:justify-between sm:px-8 lg:px-10">
                    ...
                    <p>&copy; {{ now()->year }} TaskFlow. Make progress, calmly.</p>
